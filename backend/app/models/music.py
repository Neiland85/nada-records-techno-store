...
class Track(BaseModel, SoftDeleteMixin):
    ...
    audio_files = relationship(
        "AudioFile", back_populates="track", cascade="all, delete-orphan"
    )
    licenses = relationship(
        "License", back_populates="track", cascade="all, delete-orphan"
    )
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "album_id", "disc_number", "track_number", name="uq_album_disc_track"
        ),
    )
